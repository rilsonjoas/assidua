...
function makeStyles(c: ThemeColors) {
  return StyleSheet.create({
    ...
    title: { fontSize: 14, fontWeight: '700', color: c.textSecondary, marginBottom: 12 },
    barsRow: { flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between', gap: 8 },
    barColumn: { flex: 1, alignItems: 'center' },
    barValue: { fontSize: 13, fontWeight: '700', color: c.textMuted, marginBottom: 6 },
    barTrack: {
    ...
    barDateLabel: { fontSize: 12, fontWeight: '600', color: c.textMuted, marginTop: 6 },
    legendRow: {
      flexDirection: 'row',
      flexWrap: 'wrap',
