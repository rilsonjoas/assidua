...
return [
    ...
    'description' => 'API do backend do Meus Remédios (app mobile React Native). '
        .'Auth via Sanctum (Bearer token). Só pra uso em dev/homologação — '
        .'igual ao padrão do SIC, essa doc não fica exposta em produção '
        .'(o pacote é require-dev, nem instala no build de produção).',
